...
export const portfolios6 = [
  {
    ...
    imgExtra: "/assets/portfolio/offizonee123.png",
    title: "Website Design and Development",
    description: "OffiZonee Website",
    lightbox: false,
    Date: "2025",
    ...
    website: "offizonee.com",
  },
  {
    id: 82,
    categories: ["branding", "website", "development"],
    imgSrc: "/assets/portfolio/tgp.png",
    imgExtra: "/assets/portfolio/tgp.png",
    title: "Website Design and Development",
    description: "TGP Website",
    lightbox: false,
    Date: "2025",
    Client: "Business Website",
    Services: "Branding, UI/UX Design, Front-end Development",
    Description:
      "A focused website experience built for TGP with cleaner presentation, stronger brand clarity, and a structure designed to support better business credibility.",
    website: "thoseguysprint.com",
  },
  {
    id: 83,
    categories: ["branding", "website", "development"],
    imgSrc: "/assets/portfolio/infinisoft.png",
    imgExtra: "/assets/portfolio/infinisoft.png",
    title: "Website Design and Development",
    description: "InfiniSoft Website",
    lightbox: false,
    Date: "2025",
    Client: "Agency Website",
    Services: "Branding, UI/UX Design, Front-end Development",
    Description:
      "A premium agency website created to present InfiniSoft clearly, strengthen trust, and showcase services with a sharper conversion-focused structure.",
    website: "infinisoftech.com",
  },
  {
    id: 84,
    categories: ["branding", "website", "development"],
    imgSrc: "/assets/portfolio/madmarketers.png",
    imgExtra: "/assets/portfolio/madmarketers.png",
    title: "Website Design and Development",
    description: "Mad Marketers Website",
    lightbox: false,
    Date: "2025",
    Client: "Marketing Website",
    Services: "Branding, UI/UX Design, Front-end Development",
    Description:
      "A polished website experience for Mad Marketers designed to present services clearly, build brand authority, and create a stronger path toward inquiries and conversions.",
    website: "mad-marketers-q-main.vercel.app",
  },
  {
    id: 85,
    categories: ["branding", "website", "development"],
    imgSrc: "/assets/portfolio/livespace.png",
    imgExtra: "/assets/portfolio/livespace.png",
    title: "Website Design and Development",
    description: "LiveSpace Website",
    lightbox: false,
    Date: "2025",
    Client: "Studio Website",
    Services: "Branding, UI/UX Design, Front-end Development",
    Description:
      "A refined website experience for LiveSpace Studio designed to showcase the brand with more clarity, stronger visual credibility, and a smoother path to inquiry.",
    website: "livespace-studio-main.vercel.app",
  },
  {
    id: 38,
    categories: ["UIUX Design", "branding", "redesign"],
    imgSrc: "/assets/images/demo-fancy/portfolio/TGP/tgpCover.png?v=2",

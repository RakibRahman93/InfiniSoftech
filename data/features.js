export const featureItems = [
  {
    ...
    description:
      "We deliver customized digital solutions designed to meet your unique business needs and goals.",
  },
  {
    id: 2,
    className: "col-md-4 col-lg-3 d-flex align-items-stretch mb-sm-30",
    ...
    title: "Expert Team",
    description:
      "Our skilled professionals bring innovation, precision, and expertise to every project.",
  },
  {
    id: 3,
    ...
    description:
      "We prioritize excellence, ensuring every product is user-friendly, reliable, and impactful.",
  },
];

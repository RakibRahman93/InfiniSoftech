          ...
          <div className="row" style={{justifyContent:"space-between"}}>
            ...
            <div className="col-md-10 offset-md-1  offset-lg-1 col-xl-10 d-flex align-items-center mb-md-60 mb-sm-30">
              ...
              <h1 className="hs-title-10 mb-30">
                  <span className="wow charsAnimIn fadeInUp" data-splitting="chars">
                    <span style={{ fontWeight: "bold", color: "#333" }}>
                      Transforming Ideas Into <span className="mark-decoration-3-wrap color-secondary-1-white">
                      Impactful
                      {/* <b
            ...
            {/* Mobile images section */}
             <div className="mob-hide w-100 wow fadeInLeft" data-wow-delay="0.7s">
            ...
            {/* End Image */}
            {/* Start of tech stack */}
            <div className="mob-hide w-100 wow fadeInLeft p-50" data-wow-delay="0.7s">
